...
import './Footer.css';
// import { GalleriaProgrammaticDemo } from '../Gallary/Gallary'
...
function Footer() {
    return (
        <footer className='footerSpace'>
            <div className='container-min-max-width container-fluid  d-flex justify-content-center'>
                {/* <GalleriaProgrammaticDemo></GalleriaProgrammaticDemo> */}
            </div>
            <div className="pt-3 mt-3 bg-light">
